        ...
        <header className="h-24 border-b border-white/10 flex items-center justify-between px-4 md:px-10 bg-black/10 backdrop-blur-md z-10">
          ...
          <div className="flex items-center gap-6">
            <div className="text-right">
              <p className="text-[10px] text-white/30 uppercase tracking-widest font-bold">Last Synchronized</p>
            ...
            >
              <RefreshCw className={`w-5 h-5 text-white/40 group-hover:text-white group-active:rotate-180 transition-all duration-500 ${loading ? 'animate-spin' : ''}`} />
            </button>
          </div>
        </header>
        ...
        <div className="flex-1 overflow-y-auto p-10 custom-scrollbar">
          {loading && records.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center gap-4 opacity-50">
              ...
              <p className="text-sm font-bold uppercase tracking-widest">Initializing Command Center...</p>
            </div>
          ) : error ? (
            ...
            <div className="h-full flex flex-col items-center justify-center gap-4 opacity-30">
              ...
              <p className="text-sm font-bold uppercase tracking-widest">No cases matching this filter</p>
            </div>
          ) : (
